/*
 * Script de comportamiento interactivo para el sitio de Luis Macías.
 *
 * Este archivo contiene la lógica de animaciones al hacer scroll,
 * control del chatbot, contador regresivo y otros efectos dinámicos.
 */

// Función utilitaria para abrir WhatsApp con el número de Luis.
// Utiliza el prefijo internacional +52 (México) y omite espacios.
function openWhatsApp() {
    const phone = '523329512916';
    // Mensaje opcional al iniciar la conversación
    const text = encodeURIComponent('¡Hola Luis! Vi tus promociones y me interesa saber más.');
...
// Add some interactive effects after DOM is ready
document.addEventListener('DOMContentLoaded', function() {
    // Add hover effects to cards (already handled by CSS and other listeners)
